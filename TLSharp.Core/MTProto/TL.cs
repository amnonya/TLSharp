...
namespace TLSharp.Core.MTProto
{
    ...
    public class TL
    {
        ...
        public static Message message(int id, int from_id, Peer to_id, int date, string message, MessageMedia media, int flags)
        {
            return new MessageConstructor(id, from_id, to_id, date, message, media, flags);
        }
        ...
        public static Document document(long id, long access_hash, int user_id, int date, string mime_type,
            int size, PhotoSize thumb, int dc_id, List<DocumentAttribute> attributes)
        {
            return new DocumentConstructor(id, access_hash, user_id, date, mime_type, size, thumb, dc_id, attributes);
        }
    ...
    public class MessageConstructor : Message
    {
        ...
        public MessageConstructor(int id, int from_id, Peer to_id, int date, string message, MessageMedia media, int flags)
        {
            this.id = id;
            this.from_id = from_id;
            this.to_id = to_id;
        ...
        public override void Read(BinaryReader reader)
        {
            ...
            this.media = TL.Parse<MessageMedia>(reader); //no need for my uses..
        }

        private void SetFlags(int flags)
        {
            this.flags = flags;
            this.unread = (flags & 0x01) != 0;
            this.output = (flags & 0x02) != 0;
        }
    ...
    public class DocumentConstructor : Document
    {
        ...
        public DocumentConstructor(long id, long access_hash, int user_id, int date, string mime_type,
            int size, PhotoSize thumb, int dc_id, List<DocumentAttribute> attributes)
        {
            this.id = id;
            this.access_hash = access_hash;
        ...
        public override void Write(BinaryWriter writer)
        {
            writer.Write(0xf9a39f4f); //0x9efc6326
        ...
        public override void Read(BinaryReader reader)
        {
            ...
            {
                var a = TL.Parse<DocumentAttribute>(reader);
                attributes.Add(a);
            }
        }
        ...
        public override string ToString()
        {
            return
                String.Format(
                    "(document id:{0} access_hash:{1} user_id:{2} date:{3} mime_type:'{4}' size:{5} thumb:{6} dc_id:{7}, attributes:{8})",
                    id, access_hash, user_id, date, mime_type, size, thumb, dc_id, Serializers.VectorToString(attributes));
        }
    }
    ...
    public class DocumentAttributeStickerConstructor : DocumentAttribute
    {
        ...
        public override string ToString()
        {
            return String.Format("(documentAttributeSticker)");
        }
    }
    ...
    public class DocumentAttributeAudioConstructor : DocumentAttribute
    {
        ...
        public override string ToString()
        {
            return String.Format("(documentAttributeAudio duration:{0})", duration);
        }
    }
